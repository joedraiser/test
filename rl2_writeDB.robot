...
<object class="Robot2" serializationversion="2">
  <prologue>
    ...
    <typed-variables>
      <typed-variable name="test" type-name="text"/>
    </typed-variables>
    <parameters/>
    <return-variables/>
  ...
  "gizmo":{
    ...
    "databaseMappings": [{
      ...
      "gizmo":{
        ...
        "actual": {
          "meta":{
            "className":"com.kapowtech.da.language.syntax.ProjectDatabaseMapping",
            "version":0
          },
          "gizmo":{
            "name": { "string": "" }
