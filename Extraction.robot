        ...
        "steps": [{
          ...
          "gizmo":{
            ...
            "comment": {
              ...
              "gizmo":{
                "comment": { "string": "For development purpose it can be nice to start a robot\nwith steps that resets it, e.g., by closing any application\nor Web page that the robot may have opened.\n\nThis will let the developer reset the robot and easily\nrerun the Robot without manually having to reset the \napplications." }
              }
            },
            "variables": [],
            "block": {
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "Extract value to collection.longText" }
              }
            },
            "comment": {
              "meta":{
              ...
              "gizmo":{
                "comment": { "string": "This step has the first converter container in this Robot." }
              }
            },
            "branches": [{
              "meta":{
                        ...
                        "finder": {
                          ...
                          "gizmo":{
                            ...
                            "componentSelector": {
                              ...
                              "gizmo":{
                                "text": { "string": "DIV[der_rendered=\"y\"][class=\"panel-overlay\"] &gt; P[der_rendered=\"y\"]" },
                                "comment": {
                                  "meta":{
                                    "className":"Comment",
                                    "version":0
                    ...
                    "steps": [{
                      ...
                      "gizmo":{
                        "name": {
                          ...
                          "gizmo":{
                            "customName": { "string": "Extract collection.longText" }
                          }
                        },
                        "comment": {
                          "meta":{
                          ...
                          "gizmo":{
                            "comment": { "string": "This is a Converter group, which is recognizable by\nthe purple color.\n\nA Converter group is a group where you can manipulate\nvalues. Inside a Converter group, the current flow point can\nbe moved both forward and backwards by clicking a flow\npoint prior to the current flow point.\n\nThe Converter group works especially well in a\ncombination with the State view. Click on \"Variables\" and\nsee how the state changes as the current flow point\nchanges its position.\n\nInside a Converter group, two local variables are created\nby the Robot.\n\nThe variable $$initial is a variable containing the value at \nthe beginning of the Converter group. The variable $$current \nis the result of each converter step inside the group." }
                          }
                        },
                        "converterSource": {
                          "meta":{
                            ...
                            "steps": [{
                              ...
                              "gizmo":{
                                "name": {
                                  ...
                                  "gizmo":{
                                    "customName": { "string": "Store collection.longText" }
                                  }
                                },
                                "comment": {
                                  "meta":{
                                ...
                                "leftHandSide": {
                                  ...
                                  "gizmo":{
                                    "text": { "string": "collection.longText" }
                                  }
                                }
                              }
                            }]
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "Extract value to collection.url" }
              }
            },
            "comment": {
              "meta":{
                        ...
                        "finder": {
                          ...
                          "gizmo":{
                            ...
                            "componentSelector": {
                              ...
                              "gizmo":{
                                "text": { "string": "H1[der_rendered=\"y\"] &gt; A[der_rendered=\"y\"]" },
                                "comment": {
                                  "meta":{
                                    "className":"Comment",
                                    "version":0
                    ...
                    "steps": [{
                      ...
                      "gizmo":{
                        "name": {
                          ...
                          "gizmo":{
                            "customName": { "string": "Extract collection.url" }
                          }
                        },
                        "comment": {
                          "meta":{
                            ...
                            "steps": [{
                              ...
                              "gizmo":{
                                "name": {
                                  ...
                                  "gizmo":{
                                    "customName": { "string": "Store collection.url" }
                                  }
                                },
                                "comment": {
                                  "meta":{
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "Extract value to collection.date" }
              }
            },
            "comment": {
              "meta":{
              ...
              "gizmo":{
                "comment": { "string": "This extraction procedure uses an Extract DateTime step \nthat requires a special pattern to match the extracted text \nfrom the website.\n" }
              }
            },
            "branches": [{
              "meta":{
                        ...
                        "finder": {
                          ...
                          "gizmo":{
                            ...
                            "componentSelector": {
                              ...
                              "gizmo":{
                                "text": { "string": "DIV[der_rendered=\"y\"][class=\"fl_right_mod\"]" },
                                "comment": {
                                  "meta":{
                                    "className":"Comment",
                                    "version":0
                    ...
                    "steps": [{
                      ...
                      "gizmo":{
                        "name": {
                          ...
                          "gizmo":{
                            "customName": { "string": "Extract collection.date" }
                          }
                        },
                        "comment": {
                          "meta":{
                            ...
                            "steps": [{
                              ...
                              "gizmo":{
                                ...
                                "comment": {
                                  ...
                                  "gizmo":{
                                    "comment": { "string": "Date extraction from this text does not match a standard \npattern. Therefore, we use a custom pattern." }
                                  }
                                },
                                "extractor": {
                                  "meta":{
                                    ...
                                    "pattern": {
                                      ...
                                      "gizmo":{
                                        "expression": {
                                          ...
                                          "gizmo":{
                                            "text": { "string": "'|' d MMM yyyy 'at' H:mm '|'" },
                                            "comment": {
                                              "meta":{
                                                "className":"Comment",
                                                "version":0
                            ...
                            },
                            {
                              ...
                              "gizmo":{
                                "name": {
                                  ...
                                  "gizmo":{
                                    "customName": { "string": "Store collection.date" }
                                  }
                                },
                                "comment": {
                                  "meta":{
                        ...
                        "finder": {
                          ...
                          "gizmo":{
                            ...
                            "componentSelector": {
                              ...
                              "gizmo":{
                                "text": { "string": "DIV[der_rendered=\"y\"] &gt; IMG[der_rendered=\"y\"]" },
                                "comment": {
                                  "meta":{
                                    "className":"Comment",
                                    "version":0
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "Extract value to collection.integer" }
              }
            },
            "comment": {
              "meta":{
              ...
              "gizmo":{
                "comment": { "string": "Pay special attention to this step as it uses a lot of \nconversion steps." }
              }
            },
            "branches": [{
              "meta":{
                        ...
                        "finder": {
                          ...
                          "gizmo":{
                            ...
                            "componentSelector": {
                              ...
                              "gizmo":{
                                "text": { "string": "P[der_rendered=\"y\"][class=\"fl_left\"]" },
                                "comment": {
                                  "meta":{
                                    "className":"Comment",
                                    "version":0
                    ...
                    "steps": [{
                      ...
                      "gizmo":{
                        "name": {
                          ...
                          "gizmo":{
                            "customName": { "string": "Extract collection.integer" }
                          }
                        },
                        "comment": {
                          "meta":{
                            ...
                            "steps": [{
                              ...
                              "gizmo":{
                                ...
                                "comment": {
                                  ...
                                  "gizmo":{
                                    "comment": { "string": "For some extractions, the specified field is not immediately \nready for conversion into a certain type.\n\nFor example, it is not possible to turn this text into an \nInteger value without removing some characters.\n\nIf the Current Flow point is right in front of an expression \nstep, you can see the result of the expression when opening \nthe Expression Editor.\n" }
                                  }
                                },
                                "expression": {
                                  "meta":{
                                  ...
                                  "gizmo":{
                                    "text": { "string": "=$$current.substring($$current.indexOf(\"©\")+1)" },
                                    "comment": {
                                      "meta":{
                                        "className":"Comment",
                                        "version":0
                            ...
                            },
                            {
                              ...
                              "gizmo":{
                                ...
                                "expression": {
                                  ...
                                  "gizmo":{
                                    "text": { "string": "=$$current.substring(0, $$current.indexOf(\"-\"))" },
                                    "comment": {
                                      "meta":{
                                        "className":"Comment",
                                        "version":0
                            ...
                            },
                            {
                              ...
                              "gizmo":{
                                "name": {
                                  ...
                                  "gizmo":{
                                    "customName": { "string": "Remove All Spaces" }
                                  }
                                },
                                "comment": {
                                  "meta":{
                            ...
                            },
                            {
                              ...
                              "gizmo":{
                                "name": {
                                  ...
                                  "gizmo":{
                                    "customName": { "string": "Store collection.integer" }
                                  }
                                },
                                "comment": {
                                  "meta":{
                                ...
                                "leftHandSide": {
                                  ...
                                  "gizmo":{
                                    "text": { "string": "collection.integer" }
                                  }
                                }
                              }
                            }]
