...
<object class="Robot" serializationversion="2">
  <prologue>
    ...
    <referenced-snippets/>
    <typed-variables>
      <typed-variable name="collection" type-name="TypeCollectionOut"/>
    </typed-variables>
    <parameters/>
    <return-variables>
  ...
  <property name="variables" class="Variables">
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="0">collection</property>
...
&lt;html&gt;
&lt;head&gt;
    &lt;title&gt;Extraction and Conversion
    &lt;/title&gt;
&lt;style&gt;
...
&lt;tbody&gt;
    &lt;tr class="top"&gt;
        &lt;td class="top"&gt;Extraction and Conversion&lt;/td&gt;
    &lt;/tr&gt;
    &lt;tr&gt;
        &lt;td class="top"&gt;
            &lt;p&gt;This Basic Engine Robot calls the Extraction Robot, which executes the demo.&lt;/p&gt;
  &lt;p&gt;Start the execution of the Extraction.robot by executing the Basic Engine Robot to the "Call Extraction" step and clicking the "Step Into Robot" button on the toolbar. &lt;/p&gt;
    &lt;/tr&gt;
&lt;tbody&gt;
&lt;/table&gt;
&lt;/body&gt;
&lt;/html&gt;</property>
      ...
      <object class="Transition" serializationversion="3" id="6">
        <property name="name" class="String">Call Extraction</property>
        <property name="stepAction" class="CallRobot2Step">
          <property name="robot2Name" class="String">Extraction</property>
