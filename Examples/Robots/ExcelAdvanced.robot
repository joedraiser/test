        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "Browse And Click Finance" }
              }
            },
            "comment": {
              "meta":{
                                ...
                                "finder": {
                                  ...
                                  "gizmo":{
                                    ...
                                    "componentSelector": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "LI[der_rendered=\"y\"][id=\"finance\"] &gt; A[der_rendered=\"y\"]" },
                                        "comment": {
                                          "meta":{
                                            "className":"Comment",
                                            "version":0
        ...
        },
        {
          ...
          "gizmo":{
            ...
            "comment": {
              ...
              "gizmo":{
                "comment": { "string": "Ensure that the input variable FilesPath is set correctly.\nYou can check this in the State view below." }
              }
            },
            "finder": {
              "meta":{
                                    ...
                                    "argumentsType": {
                                      ...
                                      "gizmo":{
                                        "fields": [{
                                          ...
                                          "gizmo":{
                                            "name": { "string": "Worksheet Path" },
                                            "localizationKey": { "string": "Signature.excel.kWorksheetPath" },
                                            "optional": { "boolean": "false" },
                                            "collapsible": { "boolean": "false" },
                                            "typeDefinition": {
                                              "meta":{
        ...
        },
        {
          ...
          "gizmo":{
            ...
            "comment": {
              ...
              "gizmo":{
                "comment": { "string": "Click the arrow button “&gt;” to expand the Variables box to \nsee two local variables.\n\nexcelRow: The row number for the Excel input.\nemptyRowFound: A Boolean value denoting if the first \nempty Excel row has been found.\n" }
              }
            },
            "variables": [{
              "meta":{
                ...
                "steps": [{
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "Find first empty row in excel" }
                      }
                    },
                    "comment": {
                      "meta":{
                        ...
                        "steps": [{
                          ...
                          "gizmo":{
                            "name": {
                              ...
                              "gizmo":{
                                "customName": { "string": "Extract value to emptyRow" }
                              }
                            },
                            "comment": {
                              "meta":{
                                        ...
                                        "finder": {
                                          ...
                                          "gizmo":{
                                            ...
                                            "componentSelector": {
                                              ...
                                              "gizmo":{
                                                "text": { "string": "=\"Cell[Address=\\\"$$A$$\" + (excelRow+3) + \"\\\"]\"" },
                                                "comment": {
                                                  "meta":{
                                                    "className":"Comment",
                                                    "version":0
                                    ...
                                    "steps": [{
                                      ...
                                      "gizmo":{
                                        "name": {
                                          ...
                                          "gizmo":{
                                            "customName": { "string": "Extract emptyRow" }
                                          }
                                        },
                                        "comment": {
                                          "meta":{
                                            ...
                                            },
                                            {
                                              ...
                                              "gizmo":{
                                                "name": {
                                                  ...
                                                  "gizmo":{
                                                    "customName": { "string": "Store emptyRow" }
                                                  }
                                                },
                                                "comment": {
                                                  "meta":{
                ...
                },
                {
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "Input date in Excel" }
                      }
                    },
                    "comment": {
                      "meta":{
                                ...
                                "finder": {
                                  ...
                                  "gizmo":{
                                    ...
                                    "componentSelector": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "=\"Cell[Address=\\\"$$A$$\" + (2 + excelRow) + \"\\\"]\"" },
                                        "comment": {
                                          "meta":{
                                            "className":"Comment",
                                            "version":0
                            ...
                            },
                            {
                              ...
                              "gizmo":{
                                ...
                                "text": {
                                  ...
                                  "gizmo":{
                                    "text": { "string": "=date().text() + \" \" + time().text()" },
                                    "comment": {
                                      "meta":{
                                        "className":"Comment",
                                        "version":0
                ...
                },
                {
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "Extract and insert each price" }
                      }
                    },
                    "comment": {
                      "meta":{
                                ...
                                "elementFinder": {
                                  ...
                                  "gizmo":{
                                    ...
                                    "elementSelector": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "TR[der_rendered=\"y\"] &gt; TD[der_rendered=\"y\"]:nth-of-type(2)" },
                                        "comment": {
                                          "meta":{
                                            "className":"Comment",
                                            "version":0
                                            ...
                                            "steps": [{
                                              ...
                                              "gizmo":{
                                                "name": {
                                                  ...
                                                  "gizmo":{
                                                    "customName": { "string": "Extract price" }
                                                  }
                                                },
                                                "comment": {
                                                  "meta":{
                                                    ...
                                                    "steps": [{
                                                      ...
                                                      "gizmo":{
                                                        ...
                                                        "expression": {
                                                          ...
                                                          "gizmo":{
                                                            "text": { "string": "=$$current.replaceAll(\",\",\"\").number()" },
                                                            "comment": {
                                                              "meta":{
                                                                "className":"Comment",
                                                                "version":0
                                            ...
                                            },
                                            {
                                              ...
                                              "gizmo":{
                                                "name": {
                                                  ...
                                                  "gizmo":{
                                                    "customName": { "string": "Input text from price" }
                                                  }
                                                },
                                                "comment": {
                                                  "meta":{
                                                            ...
                                                            "finder": {
                                                              ...
                                                              "gizmo":{
                                                                ...
                                                                "componentSelector": {
                                                                  ...
                                                                  "gizmo":{
                                                                    "text": { "string": "=\"Row[Index=\\\"\" + (2+excelRow) + \"\\\"]\"" },
                                                                    "comment": {
                                                                      "meta":{
                                                                        "className":"Comment",
                                                                        "version":0
                                                                ...
                                                                "finder": {
                                                                  ...
                                                                  "gizmo":{
                                                                    ...
                                                                    "selector": {
                                                                      ...
                                                                      "gizmo":{
                                                                        "text": { "string": "=\"Cell[ColumnIndex=\\\"\" + (column+2) +\"\\\"]\"" },
                                                                        "comment": {
                                                                          "meta":{
                                                                            "className":"Comment",
                                                                            "version":0
                                    ...
                                    "typeDefinition": {
                                      ...
                                      "gizmo":{
                                        ...
                                        "variants": [{
                                          ...
                                          "gizmo":{
                                            "name": { "string": "Save" },
                                            "localizationKey": { "string": "Signature.excel.kSave" },
                                            "id": { "string": "Save" },
                                            "typeDefinition": {
                                              "meta":{
                                                "className":"MethodDasType",
