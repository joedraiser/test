...
<object class="Robot" serializationversion="2">
  <prologue>
    ...
    <tags/>
    <typed-variables>
      <typed-variable name="input" type-name="every_simple_type_included"/>
    </typed-variables>
    <parameters>
      <parameter name="input" type-name="every_simple_type_included"/>
    </parameters>
    <return-variables>
      <variable name="input"/>
    </return-variables>
    ...
    <referenced-types>
      <type name="every_simple_type_included"/>
    </referenced-types>
    <triggers/>
    <sub-robots/>
    <device-mappings/>
    ...
    <object class="Variable" serializationversion="1">
      ...
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" class="TypeReference" serializationversion="0">
          <property name="typeName" class="String">every_simple_type_included</property>
        </property>
      </property>
    </object>
  </property>
