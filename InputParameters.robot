    ...
    <object class="Variable" serializationversion="1">
      ...
      <property name="initialAssignment" class="InitialVariableAssignment">
        ...
        <property name="assignments" class="AttributeAssignments">
          <property name="binaryinput" class="AttributeAssignment">
          ...
          <property name="excelinput" class="AttributeAssignment">
          ...
          <property name="htmlinput" class="AttributeAssignment">
            <property name="attributeValue" idref="1"/>
            <property name="currentlyAssigned" class="Boolean">true</property>
          ...
          <property name="pdfinput" class="AttributeAssignment">
            <property name="attributeValue" idref="1"/>
            <property name="currentlyAssigned" class="Boolean">true</property>
            <property name="lastKnownAttributeType" class="java.lang.Class">kapow.robot.plugin.common.domain.PDFAttributeType</property>
          </property>
